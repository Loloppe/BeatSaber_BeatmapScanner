    ...
    public class ArtworkViewManager : IInitializable, IDisposable
    {
        ...
        private void OnDidFinishEvent(MainMenuViewController _, MainMenuViewController.MenuButton __)
        {
            ...
            try
            {
                ...
                {
                    Plugin.star = CreateText(imageTransform, "☆", new Vector3(4.1f, 1.5f, -3f));
                }
                ...
                {
                    Plugin.star.rectTransform.Rotate(new Vector3(0, 7.5f));
                    Plugin.t.rectTransform.Rotate(new Vector3(0, 10f));
                }
            }
            catch (Exception e)
            {
